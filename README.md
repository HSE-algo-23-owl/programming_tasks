# Задание №3+  
## Задачи  
1. На повышенную оценку, по желанию, реализовать генератор тестовых данных GcdGenerator в файле gcd_generator.py.

## Примечания  
- Разработку вести в отдельной ветке, созданной на основе данной. В названии ветки префикс main заменить на название команды.
- Корректность работы функций можно проверить запустив модульные тесты в файле test.py.  
