...
def __get_distributions(profit_matrix: list[list[int]], max_investments: int) -> list[list[int]]:
    """
...
def get_invest_distributions(profit_matrix: list[list[int]]) -> dict[str: int, str: list[int]]:
    """
